...
if( isset($_POST["email"]) && isset($_POST["pass"]) && isset($_POST["submit"])) {
    ...
    $sql = $sql = "SELECT * FROM `teacher_add` WHERE `s_email`=? AND `t_password`=?";
    ...
    if ($result->num_rows == 1){
        ...
        $_SESSION["loggedin"] = true; $_SESSION["usertype"] = "teacher"; $_SESSION["tchr_name"] = $row["tchr_name"]; $_SESSION["t_id"] = $row["t_id"]; $_SESSION["email"] = $row["s_email"]; $_SESSION["center_code"] = $row["c_code"]; //var_dump($_SESSION);
     ...
     <div class="card card-login mx-auto text-center">
         <div class="card-header mx-auto ">
             <span> <img src="/assets/img/logo.png" class="responsive2 profile-img" alt="Logo"> </span><br/>
                         <span class="logo_title mt-5 text-light student-font"> Teacher Login </span>
